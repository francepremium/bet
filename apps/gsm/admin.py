...
class CompetitionAdmin(TranslationAdmin):
    list_display = ('gsm_id', 'sport', 'area', 'championship', 'name', 'is_nationnal')
    list_filter = ('sport',)
    search_fields = ('area__name_fr', 'area__name_en', 'championship__name_fr', 'championship__name_en', 'name_fr', 'name_en')
    list_editable = ('is_nationnal', )

admin.site.register(Competition, CompetitionAdmin)

class SessionAdmin(admin.ModelAdmin):
    list_display = ('gsm_id', 'oponnent_A_name', 'oponnent_B_name', 'status', 'winner', 'datetime_utc')
    search_fields = ('session_round__name', 'session_round__season__name', 'session_round__season__competition__name', 'oponnent_A_name', 'oponnent_B_name')
    list_filter = ('sport', )
